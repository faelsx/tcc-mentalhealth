...
import 'package:mentalhealth_app/shared/themes/data/info/sindromespsicomotoras.dart';
...
class SindromesPsicomoPage extends StatelessWidget {
  const SindromesPsicomoPage({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Text(
                    SindromesPsicomotoras.title,
                    style: AppTextStyles.titleMenu,
                  ),
                  Text(
                    SindromesPsicomotoras.subtitle,
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        left: 50, right: 50, top: 10, bottom: 50),
                    child: Text(
                      SindromesPsicomotoras.subtipos,
                      style: AppTextStyles.bodytext,
                      textAlign: TextAlign.justify,
                    ),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        left: 50, right: 50, top: 10, bottom: 50),
                    child: Text(
                      SindromesPsicomotoras.diagnostico,
                      style: AppTextStyles.bodytext,
                      textAlign: TextAlign.justify,
                    ),
                  ),
